...
async def gen_thumb(thumbnail, title, userid, theme, ctitle):
    ...
    draw.text((20, 45), f"Muter di {ctitle[:16]}...", fill= "white", stroke_width = 1, stroke_fill="white", font=font2)
    draw.text((25, 595), f"{title[:21]}...", fill="white", stroke_width = 2, stroke_fill="white" ,font=font)
